...
def account_register():
    ...
    return account_view.account_register(account), account.get('http_status_code')
...
def account_get(pk):
    ...
    return account_view.account_get(account), account.get('http_status_code')
...
def account_delete(pk):
    ...
    return account_view.account_delete(account), account.get('http_status_code')
